                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="" class="form-control form-control-sm">
                                        ...
                                        <option value="0" @if (old('type') ==0) selected @endif>پمپ</option>
                                        <option value="1" @if (old('type') ==1) selected @endif>چاه</option>
                                        <option value="2" @if (old('type') ==2) selected @endif>منبع</option>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="model" id="" class="form-control form-control-sm">
                                        ...
                                        <option value="Ps100" @if (old('model') =='Ps100') selected @endif>Ps100</option>
                                        <option value="Lm412" @if (old('model') =='Lm412') selected @endif>Lm412</option>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="key_type" id="key_type" class="form-control form-control-sm">
                                        ...
                                        <option value="1" @if (old('key_type') =='1') selected @endif>تک کلید</option>
                                        <option value="2" @if (old('key_type') =='2') selected @endif>دو کلید</option>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="sensor_type" id="sensor_type" class="form-control form-control-sm">
                                        <option value="">نوع را انتخاب کنید</option>
                                        <option value="level" @if (old('sensor_type') =='level') selected @endif>level</option>
                                        <option value="metric" @if (old('sensor_type') =='metric') selected @endif>metric</option>
                                    </select>
                                    @error('sensor_type')
                                        <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                            <strong>
